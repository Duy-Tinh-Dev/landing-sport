...
const Policy = () => {
  ...
  return (
    <section className="p-container py-[50px] text-tuna policy">
      <h1 className="font-bold text-[45px] relative mb-6 text-black">
        {t("title")}
      </h1>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to oYoo, the
      ...
      <p>
        Usage Data may include information such as Your Device&qpos;s Internet
      ...
      <ul>
        <li>
          Pictures and other information from your Device&qpos;s camera and
          photo library
        </li>
      </ul>
      <p>
        ...
        Company&qpos;s servers and/or a Service Provider&qpos;s server or it may
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile application&qpos;s push notifications regarding
      ...
      <p>
        ...
        Company&qpos;s operating offices and in any other places where the
      ...
      <p>
        ...
        require Your parent&qpos;s consent before We collect and use that
        information.
      </p>
      ...
      <p>
        ...
        third party&qpos;s site. We strongly advise You to review the Privacy
      ...
      <ul>
        <li>By email: hisport.app@gmail.com</li>
      </ul>
    </section>
  );
};
